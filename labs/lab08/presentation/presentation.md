...
![Выполнение необходимых команд в терминале](image/1.PNG){ #fig:003 width=50% }

## Выполнение лабораторной работы

![Файл hello.sh в текстовом редакторе vi](image/2.PNG){ #fig:004 width=70% }

## Выполнение лабораторной работы

4. Нажмите клавишу i и вводите следующий текст. (рис. [-@fig:005])

![Написание текста в vi](image/3.PNG){ #fig:005 width=60% }
...
![Выход из редактора с сохранением текста](image/4.PNG){ #fig:006 width=50% }

## Выполнение лабораторной работы

8. Сделайте файл исполняемым (рис. [-@fig:007;-@fig:008])

![Команда chmod](image/5.PNG){ #fig:007 width=60% }

## Выполнение лабораторной работы

![Файл hello.sh](image/6.PNG){ #fig:008 width=70% }
...
![Редактор vi](image/7.PNG){ #fig:009 width=70% }
...
![Изменение текста](image/8.PNG){ #fig:010 width=50% }
...
![Изменение текста](image/9.PNG){ #fig:011 width=60% }
...
![Удаление последней строки](image/10.PNG){ #fig:012 width=50% }
...
![Команда отмены](image/10.PNG){ #fig:013 width=50% }
