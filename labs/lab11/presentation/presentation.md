...
![Вторая программа](image/3.PNG){ #fig:005 width=70% }

## Выполнение лабораторной работы

![Вторая программа](image/4.PNG){ #fig:006 width=70% }
...
![Третья программа](image/5.PNG){ #fig:008 width=70% }

## Выполнение лабораторной работы

![Результат](image/6.PNG){ #fig:009 width=70% }
...
![Четвертая программа](image/7.PNG){ #fig:010 width=70% }

## Выполнение лабораторной работы

![Вызов программы в терминале](image/8.PNG){ #fig:011 width=70% }
