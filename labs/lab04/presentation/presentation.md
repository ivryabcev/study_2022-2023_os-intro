...
![Команда ls](image/1.PNG)

Опция -a. 

![Команда ls с опцией -a](image/2.PNG)
...
![Создание каталогов letters, memos, misk и из удаление](image/9.PNG)
...
![Выполнение модификации и исполнение команды из буфера обмена](image/19.PNG)
